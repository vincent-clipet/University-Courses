...
public class GenerateurRapide {
    ...
    // nombres à tester
    private FiltreRapide initial ;
    
    /** 
     * crée un générateur de limite 100 
     */
    public GenerateurRapide () { limite = 100 ; initial = new FiltreRapide(2) ;}
    /**
     * crée un générateur de limite n
     */
    public GenerateurRapide (int n) {limite = n ; initial = new FiltreRapide(2) ;}
